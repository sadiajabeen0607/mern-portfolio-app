          ...
          >
            {menus?.map((menu, i) => (
              <Link
                ...
                duration={100}
                key={i}
                className={`group flex items-center text-sm  gap-3.5 font-medium p-2 hover:bg-gray-800 cursor-pointer [&.active]:text-orange-500 [&.active]:border-l-2 [&.active]:border-orange-500 [&.active]:ps-3 `}
              >
